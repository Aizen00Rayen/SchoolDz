// Algerian school system: primary (5 years) -> middle (4 years) -> high
// school (3 years). High school year 1 (1AS) is a shared common-core track;
// years 2-3 (2AS/3AS) branch into specialty streams. i18n labels live under
// the `school_level.*` / `specialty.*` keys in lib/i18n.jsx.

export const SCHOOL_LEVELS = ["primary", "middle", "high"];

export const SCHOOL_LEVEL_YEAR_COUNT = { primary: 5, middle: 4, high: 3 };
